...
const handleSubmit = async ()=>{
    ...
    form.addEventListener("submit", async (event)=>{
        ...
        const response = await (0, _axiosDefault.default).post(`${BASE_URL}/todos`, todo);
    });
};
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hklly","bNKaB"], "bNKaB", "parcelRequire94c2")
